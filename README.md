...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyramid-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2533&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyramid-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyramid` can be installed with:

```
conda install pyramid
```

It is possible to list all of the versions of `pyramid` available on your platform with:
